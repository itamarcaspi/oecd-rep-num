...
df_R_q %>% 
  ...
  annotate("text", x = last_date + days(5), y = last_oecd + 0.15, label = label_oecd, color = "#6DCD59", size = 3.5) +
  annotate("text", x = last_date + days(5), y = last_israel - 0.15, label = label_israel, color = "#3E4A89", size = 3.5) +
