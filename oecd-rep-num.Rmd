...
p_R <- df_R_q %>% 
  ...
  annotate("label", x = last_date + days(5), y = 1.1, label = label_oecd, color = "#6DCD59", size = 3.5) +
  annotate("label", x = last_date + days(5), y = 0.9, label = label_israel, color = "#3E4A89", size = 3.5) +
  labs(
    y = expression("R"[t]),
    x = "",
